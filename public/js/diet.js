 //updated search button onClick for Autocomplete and some validation for the form
  ...
  $('#searchButton').on('click', (e) => {
      ...
      if (input != '' && ingredientSearch == null) {
          ...
          var diet = $('#diet-name').val().trim();
          if ((diet == null)) {
          alert('Please pick a diet!!');
          return false;
          }else {
          getRecipes(keyword, diet);
  ...
  var getRecipes = function(keyword, diet) {
          axios.get("https://api.yummly.com/v1/api/recipes?_app_id=67b9fed7&_app_key=3694f49499f4bce2a7594b8b1ac27168&q=" + keyword + "&allowedDiet[]=" + diet + "&requirePictures=true &maxResult=10&start=10")
              .then((result) => {
                  console.log(result);
                  let recipes = '';
                    ...
                    <div class="col-md-8">
                      <h2>Nutrition Facts </h2>
                        <ul class="list-group">
                          ...
                          <a href="/diet" class="btn btn-default">Go Back To Search</a>
